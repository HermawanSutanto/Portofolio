    ...
    <SectionWrapper id="contact" title="Hubungi Saya">
      <div className="max-w-2xl mx-auto text-center">
        <p className="text-lg text-medium mb-8">
          Saya selalu terbuka untuk mendiskusikan proyek baru, peluang kreatif,
          atau sekadar bertukar sapa. Jangan ragu untuk menghubungi saya!
        </p>
        <a
          href="mailto:wawan.ws952.ws@gmail.com"
